...
public class CollisionChecker {
	...
	public void checkTile(Entity entity) {
		...
		int entityRightWorldX = entity.worldX + entity.solidArea.x + entity.solidArea.width - 4;
		int entityTopWorldY = entity.worldY + entity.solidArea.y;
		int entityBottomWorldY = entity.worldY + entity.solidArea.y + entity.solidArea.height - 4;
	...
	public int checkObject(Entity entity, boolean player) {
		...
		for (int i = 0; i < gp.obj.length; i++) {
			if (gp.obj[i] != null) {
				// get entity solid area pos + get obj solid area pos
